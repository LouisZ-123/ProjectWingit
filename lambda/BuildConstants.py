...
TEST_ACCOUNT_PASSWORD = "TestPassword!1"

TEST_ACCOUNT_UNVERIFIED_USERNAME = 'wingit_testing_account_unverified'
TEST_ACCOUNT_UNVERIFIED_EMAIL = 'wingit.testing.account.unverified@fakedomain.com'
...
TEST_ACCOUNT_VERIFIED_KWARGS = {
    ...
    CREATION_TIME_STR: -1,
    PASSWORD_HASH_STR: gen_crypt(TEST_ACCOUNT_PASSWORD)
}
...
_VARCHAR_SIZE = 255
_PASSWORD_HASH_SIZE = len(gen_crypt("dfaonefdkaj"))
...
_CREATE_USERS_TABLE_ARGS = [
    ...
    (PASSWORD_HASH_STR, "char(%d) not null" % _PASSWORD_HASH_SIZE),
]
...
public class %(classname)s {
    ...
    public static final String PASSWORD_STR = "%(PASSWORD_STR)s";
